...
create_CV_object <-  function(data_location,
  ...
  if(is_google_sheets_location){
    ...
    cv$agile_exp    <- readr::read_csv(paste0(data_location, "agile_exp.csv"), skip = 1)
    cv$agile_certifications    <- readr::read_csv(paste0(data_location, "agile_certifications.csv"), skip = 1)
...
#' @description Construct a bar chart of agile experience
#' @param out_of The relative maximum. Used to set what a fully filled in skill bar is.
print_exp_bars <- function(cv, out_of = 5, bar_color = "#969696", bar_background = "#d9d9d9", glue_template = "default"){
...
#' @description Construct a bar chart of agile certifications
#' @param out_of The relative maximum. Used to set what a fully filled in skill bar is.
print_cert_bars <- function(cv, out_of = 5, bar_color = "#969696", bar_background = "#d9d9d9", glue_template = "default"){
